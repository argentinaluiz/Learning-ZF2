...
namespace DoctrineORMModule\Proxy\__CG__\Bookstore\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Book extends \Bookstore\Entity\Book implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bookstore\\Entity\\Book' . "\0" . 'id', '' . "\0" . 'Bookstore\\Entity\\Book' . "\0" . 'name', '' . "\0" . 'Bookstore\\Entity\\Book' . "\0" . 'category', '' . "\0" . 'Bookstore\\Entity\\Book' . "\0" . 'author', '' . "\0" . 'Bookstore\\Entity\\Book' . "\0" . 'isbn', '' . "\0" . 'Bookstore\\Entity\\Book' . "\0" . 'price');
        }
